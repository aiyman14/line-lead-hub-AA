...
import { 
  ...
  Minus, Zap, Clock, CheckCircle2, XCircle, Activity
} from "lucide-react";
import {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Ranked by efficiency</CardDescription>
              </CardHeader>
                ...
                {linePerformance.length > 0 ? (
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart data={linePerformance} layout="vertical">
                      ...
                      />
                      <Bar dataKey="totalOutput" name="Output" fill="hsl(var(--primary))" radius={[0, 4, 4, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                ) : (
                  <div className="h-[300px] flex items-center justify-center text-muted-foreground">
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {linePerformance.map(line => (
                      <tr key={line.lineId} className="border-b last:border-0 hover:bg-muted/50">
            ...
            <CardContent>
              {blockerBreakdown.length > 0 ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>No blockers reported in this period</p>
                </div>
              )}
            </CardContent>
          </Card>
        ...
        <TabsContent value="orders" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Active orders and completion status</CardDescription>
            </CardHeader>
            <CardContent>
